...
export default function ActorForm({ 
  ...
  return ( 
          <form  
            className='dark:bg-primary bg-white p-3 content-center w-[35rem] h-[17rem] rounded' 
          ...
          >
            <div className="flex justify-between items-center mb-3">
              ...
              <button 
                ...
                dark:bg-white dark:text-primary hover:opacity-80 transition rounded flex items-center justify-center' 
                type='submit'
              >

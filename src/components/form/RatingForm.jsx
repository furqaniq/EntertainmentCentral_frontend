...
export default function RatingForm({ busy, initialState, onSubmit }) {
  ...
  return (
    <div>
      <div className='p-5 dark:bg-primary bg-white rounded h-[17rem] space-y-3'>
        <div className='text-highlight dark:text-highlight-dark flex items-center relative'>
          ...
          <div className='flex itmes-center absolute top-1/2 -translate-y-1/2'>
        ...
        <textarea value={content} onChange={handleOnChange} className='w-full h-24 border-2 p-2 dark:text-white text-primary rounded 
        outline-none bg-transparent resize-none'></textarea>
